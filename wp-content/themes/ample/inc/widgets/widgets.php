...
function ample_widgets_init() {
   register_sidebar( array(
      'name'          => __( 'Top Sidebar', 'ample' ),
      'id'            => 'ample_top_sidebar',
      'description'   => __('Shows widgets at top side.', 'ample' ),
   ...
   register_sidebar( array(
      'name'          => __( 'After header left Sidebar', 'ample' ),
      'id'            => 'ample_top_header_left_sidebar',
      'description'   => __('Shows widgets at top side.', 'ample' ),
      'before_widget' => '<section id="%1$s" class="widget %2$s">',
      'after_widget'  => '</section>',
      'before_title'  => '<h3 class="widget-title">',
   ...
   register_sidebar( array(
      'name'          => __( 'After header Sidebar', 'ample' ),
      'id'            => 'ample_top_header_sidebar',
      'description'   => __('Shows widgets at top side.', 'ample' ),
      'before_widget' => '<section id="%1$s" class="widget %2$s">',
      'after_widget'  => '</section>',
      'before_title'  => '<h3 class="widget-title">',
   ...
   register_sidebar( array(
      'name'          => __( 'After header right Sidebar', 'ample' ),
      'id'            => 'ample_top_header_right_sidebar',
      'description'   => __('Shows widgets at top side.', 'ample' ),
      'before_widget' => '<section id="%1$s" class="widget %2$s">',
      'after_widget'  => '</section>',
      'before_title'  => '<h3 class="widget-title">',
   ...
   register_sidebar( array(
      'name'          => __( 'Search Right Sidebar', 'ample' ),
      'id'            => 'ample_search_right_sidebar',
   ...
   register_sidebar( array(
       'name'          => __( 'Gallery Sidebar', 'ample' ),
       'id'            => 'ample_gallery_sidebar',
       'description'   => __('Shows widgets on Gallery Page Template.', 'ample' ),
       'before_widget' => '<div id="%1$s" class="widget %2$s"><div class="inner-wrap clearfix">',
       'after_widget'  => '</div></div>',
       'before_title'  => '<h3 class="widget-title">',
       'after_title'   => '</h3>',
         ...
         ?>
            ...
            <div class="single-post">
               ...
               <div class="single-post-content">
                  ...
                  <h4 class="widget-title"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute();?>"><?php the_title(); ?></a></h4>
                  <div class="view-footer">
      					<a href="<?php echo get_category_link(18); ?> ">Переглянути всі відеоматеріали</a>    
      			  </div>
                 <?php } ?>
               </div>
