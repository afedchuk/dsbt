...
function ample_featured_image_slider() { ?>
   <div class="big-slider-wrapper">
               ...
               <div class="<?php echo $classes; ?>">
                  <?php if( !empty( $ample_slider_title ) ) { ?>
                     <div class="slider-entry-container">
                        ...
                        <?php endif; ?>
                        <div class="desc"><p><?php echo ( $ample_slider_button_text ); ?></p></div>
                        <div class="slide-next"></div>
      					<div class="slide-prev"></div>
                     </div>
                  <?php } ?>
                  <figure style="background-image: url(<?php echo esc_url( $ample_slider_image ); ?>);">
      ...
      <div class="slider-sidebar">
         <?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('ample_top_sidebar') ) : endif; ?>
      </div>
