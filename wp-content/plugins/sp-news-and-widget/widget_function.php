          ...
          $count = 0;
            ...
            if ($cust_loop->have_posts()) : while ($cust_loop->have_posts()) : $cust_loop->the_post(); $postcount++;
               ...
               $terms = get_the_terms( $post->ID, 'news-category' );
                    ...
                    ?>
                    <li class="news_li category-<?php echo $terms[0]->object_id; ?>">
...
?>
            ...
            <?php endwhile;
             ...
             wp_reset_query(); ?>
                ...
                <ul id="pager" class="pager">
                    <li class="pager-previous"><a id="prev-animate"  >&lt;</a></li>
                    <li class="pager-next"><a id="next-animate">&gt;</a></li>
                </ul>
            </div>
			<script>
   jQuery(function() {
  ...
  jQuery('#pager').vTicker('prev', {animate:true});
    jQuery('#pager').vTicker('next', {animate:true});
});
</script>
<?php
        echo $after_widget;
